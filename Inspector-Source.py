...
class MainApplication(ttk.Frame):
   ...
   # Is the relative state of charge between 20 and 30% ?
   ...
   # Is the Serial Number higher than 0004
    ...
    def __init__(self, master, *args, **kwargs):
     ...
     # The strings from the EV2400 need to come after the communication with the adapter is ready
        ...
        #info1 = ttk.Label(self, text='bqcomm ver')
        #info1.grid(row=1,column=0) 
        #info2 = ttk.Label(self, text= str(bqcomm.__version__ ))
        ...
        #info5 = ttk.Label(self, text='FW ver')
        #info5.grid(row=3,column=0) 
        #self.info6 = ttk.Label(self, text='FW ver' )
        #self.info6.grid(row=3,column=1) 
    ...
    # This label info7 Indicates if there is connection with battery  
        ...
        #B2 = ttk.Button(self, text ="SHUTDOWN", command = self.Shutdown )
